  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="pb-24">
        <div className="container px-4 md:px-6 p-[3rem] mx-auto">
              ...
              >
                ...
                <div className="relative w-full flex items-center justify-center p-6 md:p-8 lg:p-12">
                  <img
                    src={useCase.image}
                    alt={useCase.title}
                    className="w-full h-auto max-w-full block transition-transform duration-700 group-hover:scale-[1.02] rounded-lg"
                  />
                </div>
              </div>
            ))}
