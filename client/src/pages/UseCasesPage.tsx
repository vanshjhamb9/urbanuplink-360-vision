...
const useCases = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1562882168-6bc0dc1d1948?w=800&h=600&fit=crop",
  },
  {
    icon: ShoppingCart,
    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-24 bg-gradient-to-br from-secondary via-secondary to-primary text-secondary-foreground overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          ...
          <div
            className="absolute bottom-0 right-1/3 w-96 h-96 bg-primary-glow rounded-full blur-3xl animate-pulse"
