      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex h-24 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1">
            <a
              href="/"
              className={`px-5 py-2.5 rounded-lg transition-all duration-300 font-semibold text-sm relative group ${isScrolled
          ...
          {/* Mobile Menu Button */}
          <button
            className={`md:hidden p-3 rounded-lg transition-colors ${isScrolled
