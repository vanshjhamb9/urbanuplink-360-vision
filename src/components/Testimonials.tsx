...
const testimonials = [
  {
    name: "Rajesh Kumar",
    role: "Sales Director",
    company: "Metro Auto Showroom, Mumbai",
    image: "https://images.unsplash.com/photo-1556157382-97eda2d62296?w=200&h=200&fit=crop&crop=faces",
    carImage: processed004,
    quote: "UrbanUplink transformed our online sales. We've seen a 52% increase in qualified leads since implementing 360° views across our premium SUV inventory.",
    rating: 5,
    tags: ["Premium SUV", "Showroom", "Mumbai"],
  },
  {
    name: "Priya Sharma",
    role: "Marketing Manager",
    company: "Capital Auto Group, Delhi",
    image: priyaSharma,
    carImage: processed007,
    quote: "The ease of use is incredible. Our entire team was up and running in less than a day. Customer engagement with our flagship SUV listings has skyrocketed by 68%.",
    rating: 5,
    tags: ["Flagship SUV", "Premium", "Delhi"],
  },
  {
    name: "Amit Patel",
    role: "Proprietor",
    company: "Urban Auto Arena, Ahmedabad",
    image: amitPatel,
    carImage: image2r,
    quote: "Being able to show 360° views of our compact and mid-size SUV inventory has tripled our online inquiries. It's the best investment we've made for digital sales.",
    rating: 5,
    tags: ["Compact SUV", "Digital Sales", "Ahmedabad"],
  },
];
